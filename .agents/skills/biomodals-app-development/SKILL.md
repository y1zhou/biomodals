...
description: Biomodals Modal app development standards. Use when Codex is creating, editing, reviewing, or scaffolding files under src/biomodals/app/**/*_app.py or their supporting modules, including discovery, AppConfig and image construction, input safety, staged caches, fanout and resumption, upstream patches, scientific equivalence, workflow outputs, examples, and tests.
---
...
3. Load only what the app needs:
   ...
   - `references/fanout-resume.md`: parallel, interruptible, or queued work; also
     load `staged-cache.md` for Volume writes.
