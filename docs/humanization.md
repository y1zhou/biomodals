...
New schema 4 archives contain the selection CSV with four V/J gene columns,
...
CDR and potential-liability annotations. VH/VL checkboxes let you send selected
